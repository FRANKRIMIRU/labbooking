        ...
        <Link to="/book">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <p>
                Get accurate blood analysis for routine check-ups, infections,
            ...
            >
              ...
              <p>
                We offer rapid Antigen and RT-PCR tests with certified results
                for travel and health checks.
              </p>
            </div>
